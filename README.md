...
*	*_limiV									#K-mer spectrum and K-mer histogram files with final-evaluation K
		...
		**.his								#A special ASCII K-mer histogram file suitable for input to GenomeScope2 produced by Histex from 'kmer.hist' 
		*gsco_k17/							#K-mer spectrum generated by GenomeScope2
```
...
```
result file are stored in ```demo/```
