...
cat("If you use our tools in your work, please cite:", file=summaryFile, sep="\n", append=TRUE)
cat("    Xing, J., Hao, J., Tang, C. et al. A closed-loop method for precise genome size estimation using HiFi reads. BMC Genomics 26, 878 (2025). https://doi.org/10.1186/s12864-025-12031-9.", file=summaryFile, sep="\n", append=TRUE)
cat("We kindly ask that you also cite the following remarkable tools that have been integrated into LVgs:", file=summaryFile, sep="\n", append=TRUE)
